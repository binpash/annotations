...
from datatypes_new.BasicDatatypes import OptionArgPosConfigType, Operand, FileDescriptor
...
class InputOutputInfo:
    ...
    def unpack_info(self) \
        -> Tuple[List[OptionArgPosConfigType], List[FileDescriptor], List[FileDescriptor], bool, bool, bool]:
