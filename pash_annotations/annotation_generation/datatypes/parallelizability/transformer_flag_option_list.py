...
class TransformerFlagOptionList(ABC):
    ...
    def get_flag_option_list_after_transformer_application(
        self, original_flag_option_list: List[Union[Flag, OptionWithIOVar]]
    ) -> List[Union[Flag, OptionWithIOVar]]:
        pass


def return_transformer_flagoption_list_empty_if_none_else_itself(
    arg: Optional[TransformerFlagOptionList],
...
def return_transformer_flagoption_list_same_as_seq_if_none_else_itself(
    arg: Optional[TransformerFlagOptionList],
) -> TransformerFlagOptionList:
    if arg is None:
...
def apply_individual_transformer_flagoption_list(
    transformer: TransformerFlagOptionList,
...
class TransformerFlagOptionListRemove(TransformerFlagOptionList):
    ...
    def get_flag_option_list_after_transformer_application(
        ...
        return [
            flagoption
            for flagoption in original_flag_option_list
...
class ChainTransformerFlagOptionList(TransformerFlagOptionList):
    ...
    def get_flag_option_list_after_transformer_application(
        ...
        return foldl(
            apply_individual_transformer_flagoption_list,
            original_flag_option_list,
